...
public class SummonedZombieModel<T extends Entity> extends HierarchicalModel<T> {

    private final ModelPart summonedZombie;
    private final ModelPart head;

    public SummonedZombieModel(ModelPart root) {
        this.summonedZombie = root.getChild("rhino");
        this.head = summonedZombie.getChild("body").getChild("torso").getChild("head");
    }
    ...
    public void renderToBuffer(PoseStack poseStack, VertexConsumer vertexConsumer, int packedLight, int packedOverlay, float red, float green, float blue, float alpha) {
        summonedZombie.render(poseStack, vertexConsumer, packedLight, packedOverlay, red, green, blue, alpha);
    }
